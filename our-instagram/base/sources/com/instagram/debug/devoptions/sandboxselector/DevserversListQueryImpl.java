...
public final class DevserversListQueryImpl {
    ...
    public final class Builder implements DevserversListQuery.Builder {
        ...
        public PandoGraphQLRequest A00() {
            ...
            return new PandoGraphQLRequest(AbstractC40511uK.A00(), DevserversListQueryImpl.QUERY_NAME, this.params.getParamsCopy(), this.transientParams.getParamsCopy(), DevserversListResponseImpl.class, false, null, 0, null, "xdt_api__v1__devservers__list", new ArrayList());
        }
    }
