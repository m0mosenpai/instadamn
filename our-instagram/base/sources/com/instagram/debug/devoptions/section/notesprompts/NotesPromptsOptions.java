...
public final class NotesPromptsOptions implements DeveloperOptionsSection {
    ...
    public List getItems(final UserSession userSession, FragmentActivity fragmentActivity, AbstractC59962oe abstractC59962oe, AbstractC018607g abstractC018607g) {
        ...
        return AbstractC166987dD.A1J(new GHY(fragmentActivity, new View.OnClickListener() { // from class: com.instagram.debug.devoptions.section.notesprompts.NotesPromptsOptions$getItems$1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                int A05 = C0f9.A05(614428222);
                InterfaceC19610xo A0e = AbstractC31176DnK.A0e(UserSession.this);
                A0e.EEj("suggested_prompts_in_notes_last_updated_timestamp");
                A0e.EEj("suggested_prompts_in_notes");
                A0e.apply();
                C0f9.A0C(368462058, A05);
            }
        }, 2131958253));
    }
