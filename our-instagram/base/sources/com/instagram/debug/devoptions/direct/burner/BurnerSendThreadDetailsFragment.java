...
public final class BurnerSendThreadDetailsFragment extends AbstractC33235ElU implements InterfaceC60122ou {
    ...
    public C83693oE directThreadId;
    ...
    */
    private final X.GHY createMultiChoiceMenuItem(final java.lang.CharSequence r13, final java.lang.String[] r14, final java.lang.Object[] r15, int r16, java.lang.Object r17, final X.InterfaceC16660sJ r18) {
        ...
        L4a:
            ...
            goto L3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment.createMultiChoiceMenuItem(java.lang.CharSequence, java.lang.String[], java.lang.Object[], int, java.lang.Object, X.0sJ):X.GHY");
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        C35246Fgf.A02(A1E, 2131975496);
        A1E.add(new C31335Dq0(getString(2131975495)));
        String format = new SimpleDateFormat("MMM d, hh:mm:ss", Locale.US).format(new Date());
        String A0v = AbstractC25227BEk.A0v(this, 2131975495);
        C14360o3.A0A(format);
        A1E.add(new C35473Fl9(new TextView.OnEditorActionListener() { // from class: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment$onViewCreated$bulkIdEditText$2
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                return false;
            }
        }, new GYP() { // from class: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment$onViewCreated$bulkIdEditText$1
            @Override // X.GYP
        ...
        A1E.add(new C31335Dq0(getString(2131957967)));
        A1E.add(new C35473Fl9(new TextView.OnEditorActionListener() { // from class: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment$onViewCreated$messageCountEditText$2
            @Override // android.widget.TextView.OnEditorActionListener
            public final boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
                return false;
            }
        }, new GYP() { // from class: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment$onViewCreated$messageCountEditText$1
            @Override // X.GYP
            public final void onTextChanged(String str) {
                int i;
                C14360o3.A0B(str, 0);
        ...
        }, 2, AbstractC25227BEk.A0v(this, 2131957967), "10", false));
        CharSequence A0v2 = AbstractC25227BEk.A0v(this, 2131957968);
        ...
        A1E.add(new C50676MYu(AbstractC31173DnH.A07(this, createMultiChoiceMenuItem(A0v2, (String[]) A17.toArray(new String[0]), BurnerSendSettingsConfig.MessageType.values(), 1, BurnerSendSettingsConfig.MessageType.TEXT, new BurnerSendThreadDetailsFragment$onViewCreated$2(this)), A1E), new View.OnClickListener() { // from class: com.instagram.debug.devoptions.direct.burner.BurnerSendThreadDetailsFragment$onViewCreated$3
            ...
            public final void onClick(View view2) {
                ...
                int A05 = C0f9.A05(-1853991161);
                view2.setEnabled(false);
                BurnerSendThreadDetailsFragment burnerSendThreadDetailsFragment = BurnerSendThreadDetailsFragment.this;
                C83693oE c83693oE = burnerSendThreadDetailsFragment.directThreadId;
                if (c83693oE == null) {
                    A0c = AbstractC31176DnK.A0c(burnerSendThreadDetailsFragment);
                    A0c.A05 = "Failed to bulk send";
                    A0c.A0r("Thread id is null");
                    i = 2131968948;
                    ...
                    UserSession A0r = AbstractC166987dD.A0r(burnerSendThreadDetailsFragment.session$delegate);
                    BurnerSendSettingsConfig burnerSendSettingsConfig = BurnerSendThreadDetailsFragment.this.sendSettingsConfig;
                    if (burnerSendSettingsConfig == null) {
                        C14360o3.A0F("sendSettingsConfig");
                        throw C00O.createAndThrow();
                    }
                    companion.sendMessageToThread(A0r, c83693oE, burnerSendSettingsConfig.buckId, burnerSendSettingsConfig.messageType, burnerSendSettingsConfig.messageCount);
                    A0c = AbstractC31176DnK.A0c(BurnerSendThreadDetailsFragment.this);
                    A0c.A05 = "Bulk send started";
                    A0c.A0r("Message sent triggered");
                    i = 2131968948;
                    enumC193348hE = EnumC193348hE.A02;
