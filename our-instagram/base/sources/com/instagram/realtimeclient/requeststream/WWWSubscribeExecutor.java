...
public class WWWSubscribeExecutor extends SubscribeExecutor {
    public static WWWSubscribeExecutor getInstance(final UserSession userSession) {
        return (WWWSubscribeExecutor) userSession.A01(WWWSubscribeExecutor.class, new InterfaceC16820sZ() { // from class: com.instagram.realtimeclient.requeststream.WWWSubscribeExecutor$$ExternalSyntheticLambda0
    ...
    public JSONObject buildHeaderJson(GraphQLSubscriptionRequestStub graphQLSubscriptionRequestStub, String str) {
        ...
        try {
            ...
            jSONObject.put("method", AnonymousClass001.A0R("FBGQLS:", iGGraphQLSubscriptionRequestStringStub.getQueryName().toUpperCase(Locale.ENGLISH)));
            return jSONObject;
    ...
    public WWWSubscribeExecutor(InterfaceC54242ee interfaceC54242ee, InterfaceC02550Ad interfaceC02550Ad, C25671My c25671My, InterfaceC216113n interfaceC216113n, long j) {
        super(interfaceC54242ee, interfaceC02550Ad, c25671My, interfaceC216113n, j);
    }

    public WWWSubscribeExecutor(UserSession userSession, C25671My c25671My) {
