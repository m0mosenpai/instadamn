...
public final class SessionCreateJniHelper {
    public static boolean checkApkSignature(Context context) {
        try {
            ...
            for (Signature signature2 : packageInfo.signatures) {
                ...
                Log.w("ARCore-SessionCreateJniHelper", AnonymousClass001.A11("Signature mismatch.  Expected '", signature.toCharsString(), "' got '", signature2.toCharsString(), "'"));
            }
            return ((PackageItemInfo) AbstractC58320PtC.A0C(context, context.getPackageManager())).metaData.getBoolean("com.google.ar.core.disable_security_check", false);
    ...
    public static int getMinApkVersion(Context context) {
        try {
            Bundle bundle = ((PackageItemInfo) AbstractC58320PtC.A0C(context, context.getPackageManager())).metaData;
            if (bundle.containsKey("com.google.ar.core.min_apk_version")) {
                return bundle.getInt("com.google.ar.core.min_apk_version");
            }
            throw AbstractC166987dD.A18("Application manifest must contain meta-data com.google.ar.core.min_apk_version");
        } catch (PackageManager.NameNotFoundException e) {
            throw AbstractC58318PtA.A0e("Could not load application package metadata", e);
        }
    }
