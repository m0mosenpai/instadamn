...
public class FloatingActionButton$BaseBehavior extends CoordinatorLayout.Behavior {
    ...
    public boolean A0R(CoordinatorLayout coordinatorLayout, UCA uca, int i) {
    ...
    public FloatingActionButton$BaseBehavior(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C65N.A0E);
