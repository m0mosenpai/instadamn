...
public final class ChromaticAberrationTransitionFilter implements TransitionFilter {
    public static final Parcelable.Creator CREATOR = new C63475SlG(54);
    public float A00;
    public boolean A01;
    ...
    public final /* bridge */ /* synthetic */ FilterModel deepCopy() {
        ChromaticAberrationTransitionFilter chromaticAberrationTransitionFilter = new ChromaticAberrationTransitionFilter(new TransformMatrixParams(this.A02), AbstractC166997dE.A1a(this.A04), AbstractC166997dE.A1a(this.A03), 0.0f, true);
