...
public final class IABDummyContext extends C0T6 implements Parcelable, IabOrganicTrait {
    public static final Parcelable.Creator CREATOR = C63473SlE.A01(8);
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof IABDummyContext) {
                ...
                if (!C14360o3.A0K(this.A02, iABDummyContext.A02) || !C14360o3.A0K(this.A00, iABDummyContext.A00)) {
                }
            }
            return false;
        }
    ...
    public final String toString() {
        return AbstractC25232BEp.A1F("eligibleExperienceType", this.A00, AbstractC166987dD.A1L(PublicKeyCredentialControllerUtility.JSON_KEY_TYPE, AbstractC61701RsI.A00(this.A01)), AbstractC166987dD.A1L("click_ids", this.A02)).toString();
    }
