...
public class ReactDropdownPickerManager$$PropsSetter implements ViewManagerPropertyUpdater$ViewManagerSetter {
    ...
    public final void Bir(Map map) {
        String A19 = AbstractC65703TsZ.A19(map);
        map.put("backgroundColor", "Color");
        map.put("color", "Color");
        map.put("elevation", "number");
        AbstractC65702TsY.A1R("enabled", "boolean", map);
        map.put("importantForAccessibility", A19);
        AbstractC65703TsZ.A1P(DialogModule.KEY_ITEMS, "Array", A19, map);
        AbstractC65703TsZ.A1Z(map);
        AbstractC65704Tsa.A09("boolean", "number", map);
        AbstractC65703TsZ.A1T("number", A19, map);
        map.put("prompt", A19);
        AbstractC65703TsZ.A1S(A19, "number", map);
        map.put("selected", "number");
        map.put("shadowColor", "Color");
        AbstractC65703TsZ.A1R("testID", A19, "number", map);
    ...
    */
    public final /* bridge */ /* synthetic */ void Ebp(android.view.View r7, com.facebook.react.uimanager.ViewManager r8, java.lang.Object r9, java.lang.String r10) {
        /*
            Method dump skipped, instructions count: 1342
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.fbreact.views.picker.ReactDropdownPickerManager$$PropsSetter.Ebp(android.view.View, com.facebook.react.uimanager.ViewManager, java.lang.Object, java.lang.String):void");
    }
}
