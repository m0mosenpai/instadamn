...
public final class HiddenActivity$handleCreatePassword$1$1 extends C0YY implements InterfaceC16660sJ {
    ...
    public final void invoke(SavePasswordResult savePasswordResult) {
        try {
            ...
            hiddenActivity2.setupFailure(resultReceiver, CredentialProviderBaseController.CREATE_UNKNOWN, AbstractC166997dE.A0y("During save password, found UI intent sender failure: ", e));
        }
    }
