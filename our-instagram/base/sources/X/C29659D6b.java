...
public final class C29659D6b extends C0YY implements InterfaceC16820sZ {
    public final /* synthetic */ Fragment A00;
    public final /* synthetic */ String A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C29659D6b(Fragment fragment, String str) {
        super(0);
        this.A00 = fragment;
        this.A01 = str;
    }
    ...
    public final Object invoke() {
        Object A0m;
        if (Serializable.class.isAssignableFrom(ContentNotesImmersiveReplyContent.class)) {
        ...
        } else if (AbstractC25226BEj.A1a(ContentNotesImmersiveReplyContent.class)) {
            A0m = AbstractC25231BEo.A0m(this.A00, this.A01);
        } else {
            throw AbstractC25231BEo.A0i(this.A01);
        }
        if (!(A0m instanceof ContentNotesImmersiveReplyContent)) {
            return null;
        }
        return A0m;
    }
