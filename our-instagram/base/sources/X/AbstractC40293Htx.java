...
public abstract class AbstractC40293Htx {
    public static C38768H5i parseFromJson(C16L c16l) {
        String A1P;
        String A1P2;
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                } else if (AbstractC111324zv.A00(184).equals(A0q)) {
                    if (c16l.A11() == C16R.A0G) {
                        A1P2 = null;
                    } else {
                        A1P2 = c16l.A1P();
                    }
                    instapalCharacterType = (InstapalCharacterType) InstapalCharacterType.A01.get(A1P2);
                    if (instapalCharacterType == null) {
                        instapalCharacterType = InstapalCharacterType.A09;
                    }
            ...
            return new C38768H5i(instapalCharacterType, stickerTraySurface, subscriptionStickerDict, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str, str2, str3, str4, str5, str6, str7);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
