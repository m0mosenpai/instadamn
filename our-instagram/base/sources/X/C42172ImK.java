...
public final class C42172ImK implements C5R5 {
    public final String A00;

    @Override // X.C5R5
    public final C1ON BDA(UserSession userSession, boolean z) {
        C14360o3.A0B(userSession, 0);
        return AbstractC31172DnG.A0T(AbstractC41705Idb.A00(userSession, null), "trend_id", this.A00);
    }

    @Override // X.C5R5
    public final C1ON C57(UserSession userSession, String str) {
        C14360o3.A0B(userSession, 0);
        return AbstractC31172DnG.A0T(AbstractC41705Idb.A00(userSession, str), "trend_id", this.A00);
    }
