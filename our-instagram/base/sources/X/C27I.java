...
public final class C27I implements InterfaceC449925e, InterfaceC13000lm {
    public final UserSession A00;

    public C27I(UserSession userSession) {
        ...
        try {
            ...
            if (list != null) {
                for (C2ED c2ed : list) {
                    ...
                    jSONObject2.put("thread_v2_id", c2ed.BKb().A01);
                    jSONObject2.put("thread_oldest_cursor", c2ed.C7V());
                    jSONObject2.put("message_ids", AbstractC001800i.A0P(", ", "", "", Ab7, C50299MJd.A00));
            ...
            C0K8.A0F("ArmadilloExpressMessageIdsReportLogCollector", "Unable to create log due to JSONException", e);
            return null;
        }
    }
