...
public final class C66883UcZ extends C2JS implements C2JT {
    @Override // X.C2JS
    public final C4OU modelSelectionSet() {
        ...
        return new C4OU(new C4OM[]{c4ow, A0N, new C4OW(c94894Ou, "is_fb_sticker"), new C4OW(c94894Ou, "is_hidden"), new C4OW(c94894Ou, "is_pinned"), new C4OW(c94894Ou, "is_sticker"), new C4OK(C66882UcY.class, "poll_sticker", -760737777), new C4OW(c173847oc, "rotation"), new C4OW(c173847oc, "start_time_ms"), AbstractC58319PtB.A0M(c173847oc), new C4OW(c173847oc, "x"), new C4OW(c173847oc, "y"), new C4OW(c173847oc, "z")});
    }

    public C66883UcZ(int i) {
        super(i);
    }
