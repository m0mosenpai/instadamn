...
public abstract class AbstractC40091HqI {
    public static MUD parseFromJson(C16L c16l) {
        ...
        try {
            ...
            if (simpleImageUrl == null && (c16l instanceof C07950bF)) {
                AbstractC166997dE.A1V("cover_artwork_uri", c16l, "MoodsData");
            } else if (str != null || !(c16l instanceof C07950bF)) {
                if (str2 == null && (c16l instanceof C07950bF)) {
                    AbstractC166997dE.A1V(PublicKeyCredentialControllerUtility.JSON_KEY_NAME, c16l, "MoodsData");
                } else {
                    return new MUD((ImageUrl) simpleImageUrl, str, str2, 5);
                }
            } else {
                AbstractC166997dE.A1V(PublicKeyCredentialControllerUtility.JSON_KEY_ID, c16l, "MoodsData");
            }
