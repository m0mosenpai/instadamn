...
public final class Q4D extends SparseArray {
    public Q4D() {
        put(0, "/buddy_list");
        put(1, "/create_thread");
        ...
        put(118, "/t_tcpr");
        put(119, "/t_ts");
        put(HucClient.BODY_UPLOAD_TIMEOUT_SECONDS, "/t_ts_rp");
        put(121, "/t_mt_req");
        put(122, "/t_mt_resp");
        put(123, "/t_inbox");
        put(124, "/p_a_req");
        ...
        put(AbstractC62862SUj.MAX_FACTORIAL, "/omni_connect_sync_req");
        put(172, "/br_sr");
        put(174, "/sr_res");
        ...
        put(C8S8.DEFAULT_SWIPE_ANIMATION_DURATION, "/generative_group_ranking_send_updated_scores");
