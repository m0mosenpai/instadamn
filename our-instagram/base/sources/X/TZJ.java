...
public class TZJ<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    public boolean A02;
    public final int A04;
    public volatile C64902TZc A05;
    ...
    public final boolean equals(Object obj) {
        ...
        if (size == tzj.size()) {
            ...
            if (size2 != tzj.A00.size()) {
                return entrySet().equals(tzj.entrySet());
            }
            for (int i = 0; i < size2; i++) {
                if (((Map.Entry) this.A00.get(i)).equals(tzj.A00.get(i))) {
                }
            }
            if (size2 != size) {
                return this.A01.equals(tzj.A01);
            }
            return true;
        }
        return false;
    ...
    private int A00(Comparable comparable) {
        ...
        if (A05 >= 0) {
            int compareTo = comparable.compareTo(((C64767TTb) this.A00.get(A05)).A01);
            if (compareTo > 0) {
                i = A05 + 2;
                return -i;
            }
        ...
        while (i2 <= A05) {
            int i3 = (i2 + A05) / 2;
            int compareTo2 = comparable.compareTo(((C64767TTb) this.A00.get(i3)).A01);
            if (compareTo2 < 0) {
                A05 = i3 - 1;
            } else {
                if (compareTo2 <= 0) {
    ...
    public static void A03(TZJ tzj) {
        if (!tzj.A02) {
        } else {
    ...
    public final Object get(Object obj) {
        ...
        if (A00 >= 0) {
            return ((C64767TTb) this.A00.get(A00)).getValue();
        }
    ...
    public static Object A01(TZJ tzj, int i) {
        A03(tzj);
        Object value = ((C64767TTb) tzj.A00.remove(i)).getValue();
        if (!tzj.A01.isEmpty()) {
            Iterator it = tzj.A02().entrySet().iterator();
            List list = tzj.A00;
            Map.Entry A1K = AbstractC166987dD.A1K(it);
            list.add(new C64767TTb(tzj, (Comparable) A1K.getKey(), A1K.getValue()));
            it.remove();
        }
        return value;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int A00 = A00(comparable);
        if (A00 >= 0) {
            return ((C64767TTb) this.A00.get(A00)).setValue(obj);
        }
        A03(this);
        ...
        if (this.A00.size() == i2) {
            C64767TTb c64767TTb = (C64767TTb) this.A00.remove(i2 - 1);
            A02().put(c64767TTb.A01, c64767TTb.getValue());
        }
        this.A00.add(i, new C64767TTb(this, comparable, obj));
        return null;
    }
