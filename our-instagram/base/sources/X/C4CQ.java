...
public abstract class C4CQ {
    public static C4CR parseFromJson(C16L c16l) {
        String A1P;
        C14360o3.A0B(c16l, 0);
        try {
            ...
            if (onboardingEntryActionType == null && (c16l instanceof C07950bF)) {
                ((C07950bF) c16l).A03.A00("action_type", "AppreciationCommentEntryObjectImpl");
                throw C00O.createAndThrow();
            }
            return new C4CR(onboardingEntryActionType);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
