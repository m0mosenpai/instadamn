...
public final class C45476KBo extends AbstractC59962oe implements InterfaceC60122ou {
    ...
    public final String getModuleName() {
        return AbstractC111324zv.A00(2820);
    }
                ...
                if (igdsHeadline2 != null) {
                    ...
                    if (igdsBottomButtonLayout != null) {
                        ...
                        if (igdsBottomButtonLayout2 != null) {
                            igdsBottomButtonLayout2.setPrimaryActionOnClickListener(ViewOnClickListenerC48074LPz.A00(this, 14));
                            IgdsBottomButtonLayout igdsBottomButtonLayout3 = this.A03;
                            if (igdsBottomButtonLayout3 != null) {
                                igdsBottomButtonLayout3.setSecondaryActionOnClickListener(ViewOnClickListenerC48074LPz.A00(this, 15));
                                return;
                            }
                        }
                    }
    ...
    public final void onCreate(Bundle bundle) {
        int A02 = C0f9.A02(-1686797759);
        super.onCreate(bundle);
        this.A01 = AbstractC31177DnL.A0R(this);
        this.A00 = requireContext().getDrawable(R.drawable.ig_illustrations_illo_nudity_detection_refresh);
        C0f9.A09(1803897160, A02);
    }

    @Override // androidx.fragment.app.Fragment
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int A02 = C0f9.A02(-720902762);
        C14360o3.A0B(layoutInflater, 0);
        View A0R = AbstractC25226BEj.A0R(layoutInflater, viewGroup, R.layout.on_device_nudity_inbox_qp_cta_nux, false);
        C0f9.A09(729000964, A02);
        return A0R;
    }

    @Override // X.AbstractC59962oe, androidx.fragment.app.Fragment
    public final void onDestroy() {
        int A02 = C0f9.A02(1497412646);
        super.onDestroy();
        C5zZ c5zZ = this.A02;
        if (c5zZ == null) {
