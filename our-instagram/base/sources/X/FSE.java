...
public final class FSE {
    /* JADX WARN: Type inference failed for: r5v0, types: [X.1um, X.EAs, X.1ul] */
    public static C32145EAs parseFromJson(C16L c16l) {
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                } else if ("members_info".equals(A0s)) {
                    if (c16l.A11() == C16R.A0C) {
                        arrayList = AbstractC166987dD.A1E();
                        while (c16l.A1J() != C16R.A08) {
            ...
            C14360o3.A0A(list2);
            c40791um.A00 = new E6K(str, list, list2, AbstractC31172DnG.A1b(c40791um.A01));
            return c40791um;
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
