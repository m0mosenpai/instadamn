...
public abstract class AbstractC40241Ht5 {
    public static H59 parseFromJson(C16L c16l) {
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                } else if ("suggested_product_ids".equals(A0s)) {
            ...
            return new H59(str, str2, str3, arrayList);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
