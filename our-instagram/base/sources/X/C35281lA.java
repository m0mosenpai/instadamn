...
public final class C35281lA implements InterfaceC29301b7 {
    public static final C0KV A02 = C35291lB.A00;
    ...
    public final /* bridge */ /* synthetic */ void ENr(C19260xA c19260xA, InterfaceC37261GbE interfaceC37261GbE, C1OW c1ow) {
        C35271l9 c35271l9 = (C35271l9) c1ow;
        C14360o3.A0B(c35271l9, 0);
        C14360o3.A0B(interfaceC37261GbE, 2);
        List C7R = c35271l9.C7R();
        C14360o3.A07(C7R);
        JTa jTa = ((C1OW) c35271l9).A02;
        if (C7R.size() == 1) {
            UserSession userSession = this.A00;
            DirectThreadKey directThreadKey = (DirectThreadKey) c35271l9.C7R().get(0);
            C44996Jvm A00 = AbstractC46912Kot.A00(jTa);
            String str = c35271l9.A01;
            String str2 = c35271l9.A00;
            if (str2 != null) {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("item_media_igid", str2);
                } catch (JSONException unused) {
                    C0w9.A03("DirectMessageApi", "Error forming json for potato reply");
                }
    ...
    public C35281lA(UserSession userSession) {
