...
public final class C7PX implements C7P8 {
    @Override // X.C7P8
    ...
    public final boolean AFc(UserSession userSession, C83403nh c83403nh, int i) {
        ...
        if (i == 29 && C18U.A06(C06090Tz.A05, userSession, 36319312902429849L)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean AG0(UserSession userSession, C83403nh c83403nh) {
        C14360o3.A0B(userSession, 0);
        return C18U.A06(C06090Tz.A05, userSession, 36319312902560923L);
    }
