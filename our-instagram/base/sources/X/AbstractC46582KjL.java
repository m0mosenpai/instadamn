...
public abstract class AbstractC46582KjL {
    public static C45127Jxw parseFromJson(C16L c16l) {
        ...
        try {
            ...
            if (user == null && (c16l instanceof C07950bF)) {
                AbstractC166997dE.A1V("actor", c16l, "BatchedReactionItem");
            } else if (str == null && (c16l instanceof C07950bF)) {
                AbstractC166997dE.A1V("emoji", c16l, "BatchedReactionItem");
            } else {
                return new C45127Jxw(user, str, 8);
            }
