...
public final class GBL implements C73R {
    public final Context A00;
    public final InterfaceC151446rm A01;
    public final C73S A02;
    public final User A03;

    public GBL(Context context, InterfaceC151446rm interfaceC151446rm, User user) {
    ...
    public final String Aj7() {
        return AbstractC166997dE.A0p(this.A00, 2131965668);
    }

    @Override // X.C73R
    public final void onClick() {
        this.A01.D0s(this.A03, "button_tray");
    }
