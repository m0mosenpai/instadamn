...
public final class C4ZC extends C4SW {
    @Override // X.C4SW
    public final void A00(InterfaceC02550Ad interfaceC02550Ad) {
        ...
        InterfaceC02590Ai A00 = c18920wW.A00(c18920wW.A00, "video_buffering_started");
        if (A00.isSampled()) {
                    ...
                    if (str7 != null) {
                        ...
                        if (f != null) {
                            ...
                            if (bool != null) {
                                ...
                                if (c95684Sc.A0J != null) {
                                    d5 = Double.valueOf(r0.floatValue());
                                }
                                A00.A8I("lsp", d5);
                                ...
                                A00.AAP("tracker_id", c95684Sc.A1G);
            ...
            if (c95684Sc2 != null && z) {
                A00.AAk("historical_avg_bitrate", c95684Sc2.A1N);
                A00.AAk("historical_requested_bytes", c95684Sc2.A1O);
                A00.AAk("historical_stream_type", c95684Sc2.A1P);
            }
            ...
            if (c95714Sf != null) {
                if (z) {
                    ...
                    if (c95714Sf.A0M != null) {
                        l17 = Long.valueOf(r0.intValue());
                    } else {
                        l17 = null;
                    }
                    A00.A9K("stale_mpd_count", l17);
                }
                C0Zx c0Zx = new C0Zx();
