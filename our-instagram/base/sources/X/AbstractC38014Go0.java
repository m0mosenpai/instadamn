...
public abstract class AbstractC38014Go0 {
    public static C37418Gdy parseFromJson(C16L c16l) {
        String A1P;
        C14360o3.A0B(c16l, 0);
        try {
            ...
            return new C37418Gdy(stickerTraySurface, subscriptionStickerDict, c101394gx, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str, str2, str3, str4, str5, str6);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
