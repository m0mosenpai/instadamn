...
public final class C35391lL implements InterfaceC29301b7 {
    public static final C0KV A02 = C35401lM.A00;
    ...
    public final /* bridge */ /* synthetic */ void ENr(C19260xA c19260xA, InterfaceC37261GbE interfaceC37261GbE, C1OW c1ow) {
        C35371lJ c35371lJ = (C35371lJ) c1ow;
        C14360o3.A0B(c35371lJ, 0);
        C14360o3.A0B(interfaceC37261GbE, 2);
        List C7R = c35371lJ.C7R();
        C14360o3.A07(C7R);
        JTa jTa = ((C1OW) c35371lJ).A02;
        if (C7R.size() == 1) {
            UserSession userSession = this.A00;
            DirectThreadKey directThreadKey = (DirectThreadKey) c35371lJ.C7R().get(0);
            C44996Jvm A00 = AbstractC46912Kot.A00(jTa);
            String str = c35371lJ.A01;
            String str2 = c35371lJ.A00;
            if (str2 != null) {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("presence_id", str2);
                } catch (JSONException unused) {
                    C0w9.A03("DirectMessageApi", "Error forming json for wall post reply");
                }
                C25621Ms A002 = LLX.A00(userSession, AbstractC47211Ktk.A07, A00, directThreadKey, jSONObject);
                A002.A9s("text", str);
    ...
    public C35391lL(UserSession userSession) {
