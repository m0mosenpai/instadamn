...
public final class C33211hj implements InterfaceC29301b7 {
    public static final C0KV A02 = C33221hk.A00;
    ...
    public final /* bridge */ /* synthetic */ void ENr(C19260xA c19260xA, InterfaceC37261GbE interfaceC37261GbE, C1OW c1ow) {
        String str;
        C33191hh c33191hh = (C33191hh) c1ow;
        C14360o3.A0B(c33191hh, 0);
        C14360o3.A0B(interfaceC37261GbE, 2);
        UserSession userSession = this.A00;
        DirectThreadKey directThreadKey = c33191hh.A03;
        if (directThreadKey != null) {
            C44996Jvm A00 = AbstractC46912Kot.A00(((C1OW) c33191hh).A02);
            String str2 = c33191hh.A05;
            if (str2 != null) {
                String str3 = c33191hh.A04;
                if (str3 != null) {
                    AnonymousClass442 anonymousClass442 = c33191hh.A02;
                    JSONObject jSONObject = new JSONObject();
                    try {
                        jSONObject.put("sticker_id", str2);
                        jSONObject.put("query_string", str3);
                        jSONObject.put("embedded_ent_type", AbstractC47211Ktk.A01);
                    } catch (JSONException unused) {
                        C0w9.A03("DirectMessageApi", "Error creating pass it on json for direct message");
                    }
                    C25621Ms A002 = LLX.A00(userSession, AbstractC47211Ktk.A01, A00, directThreadKey, jSONObject);
    ...
    public C33211hj(UserSession userSession) {
