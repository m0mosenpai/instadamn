...
public abstract class AbstractC63313ShL {
    public static String A00(String str, int i, int i2) {
        ...
        return AbstractC62215S2k.A00(str2, A1a);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        throw AbstractC58318PtA.A0a(AbstractC62215S2k.A00(str, A1Z));
    }

    public static void A02(int i, int i2) {
        if (i >= 0 && i <= i2) {
        } else {
            throw AbstractC58318PtA.A0a(A00("index", i, i2));
        }
    }
    ...
    public static void A03(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 >= 0 && i2 <= i3) {
                    A00 = AbstractC62215S2k.A00("end index (%s) must not be less than start index (%s)", AbstractC25228BEl.A1Z(Integer.valueOf(i2), i));
                } else {
    ...
    public static void A04(Object obj, Object obj2) {
        if (obj != null) {
            ...
            throw AbstractC166987dD.A15((String) obj2);
        }
    }
}
