...
public abstract class AbstractC40310HuF {
    public static C38780H5u parseFromJson(C16L c16l) {
        String A1P;
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                } else if (AbstractC111324zv.A00(1202).equals(A0q)) {
            ...
            return new C38780H5u(ure, stickerTraySurface, subscriptionStickerDict, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str, str2, str3, str4, str5, str6);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
