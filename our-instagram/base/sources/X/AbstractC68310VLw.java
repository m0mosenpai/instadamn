...
public abstract class AbstractC68310VLw {
    public static final Number A00(C6FQ c6fq, C6FW c6fw) {
        ...
        float width = A05 != null ? A05.getWidth() : 0;
        if (str == null || !str.equalsIgnoreCase("px")) {
            if (str != null && str.equalsIgnoreCase("dp")) {
                ...
                AbstractC25241Le.A02("bk.action.component.GetWidth2", AnonymousClass001.A0R("Unrecognised unit string ", str));
                return null;
            }
        }
        return C6DZ.A00(width);
    }
}
