...
public final class C7PQ implements C7P8 {
    @Override // X.C7P8
    ...
    public final boolean AFu(UserSession userSession, C83403nh c83403nh) {
        ...
        if (c83403nh.A0h() != null && !c83403nh.A2P) {
            return true;
        }
        return false;
    }
    ...
    public final boolean AFv(UserSession userSession, C83403nh c83403nh) {
        ...
        C14360o3.A0B(c83403nh, 1);
        if (((!c83403nh.A1l(C08730cb.A00(userSession).A00()) && c83403nh.A1e(userSession)) || c83403nh.A1V()) && c83403nh.A0e != null) {
            return true;
        }
        return false;
    }
    ...
    public final boolean AFx(UserSession userSession, C83403nh c83403nh) {
        ...
        C14360o3.A0B(c83403nh, 1);
        if (c83403nh.A1V()) {
            if (JUW.A03(userSession, c83403nh.A1S()) && c83403nh.A1b()) {
                return false;
            }
            return true;
        }
    ...
    public final boolean AGC(UserSession userSession, C83403nh c83403nh, int i) {
        C14360o3.A0B(userSession, 0);
        C14360o3.A0B(c83403nh, 1);
        if (C14360o3.A0K(userSession.userId, c83403nh.BtE()) && !c83403nh.A1P()) {
            return true;
        }
        return false;
    }
