...
public final class C36651nO implements C0KV {
    public static final C36651nO A00 = new C36651nO();

    @Override // X.C0KV
    public final /* bridge */ /* synthetic */ Object AXR(UserSession userSession) {
        int A03 = C0f9.A03(902678865);
        int A032 = C0f9.A03(-1937889297);
        ...
        C4L3 c4l3 = new C4L3(A002) { // from class: X.4Ls
            ...
            public final AbstractC1333760g E6D(C5lP c5lP, C125205lR c125205lR, List list, Map map, InterfaceC16620sF interfaceC16620sF, InterfaceC16620sF interfaceC16620sF2, boolean z) {
                ...
                if (str != null && C14360o3.A0K(c125205lR.A00, "replace")) {
                    try {
                        FGE parseFromJson = F48.parseFromJson(C16V.A00(c125205lR.A02));
                        ...
                        c2ds.FBV(str, ((C34503FIp) list2.get(0)).A01, ((C34503FIp) list2.get(0)).A00);
                        return C1333660e.A00;
                    } catch (IOException e) {
                        return new C1334160k(e, "invalid_direct_nickname_settings_payload", "Invalid DirectNicknameUpdate payload");
                    }
                }
                return C1333860h.A00;
            }
        };
        C0f9.A0A(-223919538, A032);
        C0f9.A0A(-1210572161, A03);
        return c4l3;
    }
}
