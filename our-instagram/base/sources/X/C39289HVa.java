...
public final class C39289HVa extends C17T implements YR4 {
    ...
    public final StickerTraySurface C4I() {
        return AbstractC37303Gc4.A09(this, JC9.A00);
    }

    @Override // X.YR4
    public final JME CH5() {
        return (JME) A05(-131535666, HVZ.class);
    }

    @Override // X.YR4
    public final YR4 EBC(C1DY c1dy) {
        this.A00 = AbstractC37302Gc3.A0E(c1dy, AbstractC37302Gc3.A0F(this.A00, this));
        return this;
    }

    @Override // X.YR4
    public final H74 F3r(C1DY c1dy) {
        String A0d = A0d();
        String A0c = A0c();
        String A0b = A0b();
        String A0Z = A0Z();
        ...
        StickerTraySurface A092 = AbstractC37303Gc4.A09(this, JC9.A00);
        JME CH5 = CH5();
        if (CH5 != null) {
            h73 = CH5.F3q();
        }
        return new H74(A092, A09, h73, A0E, A0C, A0F, A0D, A0G(), A0J(), A0H(), A0I(), A0V, A0W, A0X, A0Y, A0a2, A0d, A0c, A0b, A0Z, A0e, A0a);
    }

    @Override // X.YR4
    public final TreeUpdaterJNI F7o() {
        TreeUpdaterJNI treeUpdaterJNI = TreeUpdaterJNI.$redex_init_class;
        return AbstractC25234BEr.A0P(this, Xi5.A00(this));
    }
    ...
    @Override // X.YR4
    public final H74 F3s(C1DV c1dv) {
        return F3r(AbstractC25235BEs.A0b(c1dv));
    }
