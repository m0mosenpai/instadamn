...
public final class C58383PuN extends AbstractC61610RqZ {
    public int A00;
    ...
    public C58383PuN(InputStream inputStream) {
    ...
    public static void A01(C58383PuN c58383PuN) {
        int i = c58383PuN.A00 + c58383PuN.A05;
        c58383PuN.A00 = i;
        int i2 = c58383PuN.A04 + i;
    ...
    public static boolean A03(C58383PuN c58383PuN, int i) {
        int i2 = c58383PuN.A03;
        int i3 = i2 + i;
        int i4 = c58383PuN.A00;
        if (i3 > i4) {
            int i5 = c58383PuN.A04;
            if (i > (Integer.MAX_VALUE - i5) - i2 || i5 + i2 + i > c58383PuN.A01) {
                return false;
            }
            if (i2 > 0) {
                if (i4 > i2) {
            ...
            InputStream inputStream = c58383PuN.A06;
            int read = inputStream.read(c58383PuN.A07, i4, Math.min(4096 - i4, (Integer.MAX_VALUE - i5) - i4));
    ...
    public static byte[] A05(C58383PuN c58383PuN, int i) {
        if (i >= 0) {
            int i2 = c58383PuN.A04;
            int i3 = c58383PuN.A03;
            int i4 = i2 + i3 + i;
            if (i4 - Integer.MAX_VALUE <= 0) {
                int i5 = c58383PuN.A01;
                if (i4 <= i5) {
                    int i6 = c58383PuN.A00 - i3;
                    int i7 = i - i6;
                    if (i7 >= 4096 && i7 > c58383PuN.A06.available()) {
                        return null;
                    }
                    byte[] bArr = new byte[i];
                    System.arraycopy(c58383PuN.A07, c58383PuN.A03, bArr, 0, i6);
                    c58383PuN.A04 += c58383PuN.A00;
                    c58383PuN.A03 = 0;
                    c58383PuN.A00 = 0;
                    while (i6 < i) {
                        int read = c58383PuN.A06.read(bArr, i6, i - i6);
                        if (read != -1) {
                            c58383PuN.A04 += read;
                            i6 += read;
                        } else {
                ...
                c58383PuN.A0R((i5 - i2) - i3);
                throw AbstractC58321PtD.A0P();
            }
            throw AbstractC58318PtA.A0H("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
        }
    ...
    */
    public final int A0N() {
        ...
        L6d:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C58383PuN.A0N():int");
    }
    ...
    */
    public final long A0P() {
        ...
        La7:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C58383PuN.A0P():long");
    }
    ...
    public static ArrayList A00(C58383PuN c58383PuN, int i) {
        ...
        while (i > 0) {
            ...
            int i2 = 0;
            while (i2 < min) {
                int read = c58383PuN.A06.read(bArr, i2, min - i2);
                if (read != -1) {
                    c58383PuN.A04 += read;
                    i2 += read;
                } else {
    ...
    public static void A02(C58383PuN c58383PuN, int i) {
        if (!A03(c58383PuN, i)) {
            if (i > (Integer.MAX_VALUE - c58383PuN.A04) - c58383PuN.A03) {
                throw AbstractC58318PtA.A0H("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
            }
            throw AbstractC58321PtD.A0P();
        }
    ...
    public static byte[] A04(C58383PuN c58383PuN, int i) {
        byte[] A05 = A05(c58383PuN, i);
        if (A05 == null) {
            int i2 = c58383PuN.A03;
            int i3 = c58383PuN.A00;
            int i4 = i3 - i2;
            c58383PuN.A04 += i3;
            c58383PuN.A03 = 0;
            c58383PuN.A00 = 0;
            ArrayList A00 = A00(c58383PuN, i - i4);
            A05 = new byte[i];
            System.arraycopy(c58383PuN.A07, i2, A05, 0, i4);
