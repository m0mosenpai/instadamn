...
public abstract class C4A0 {
    public static C4A2 parseFromJson(C16L c16l) {
        String A1P;
        C14360o3.A0B(c16l, 0);
        try {
            ...
            return new C4A2(originalSoundData, stickerTraySurface, subscriptionStickerDict, musicOverlayStickerModel, f, f2, f3, f4, f5, f6, f7, f8, num, num2, num3, num4, num5, str, str2, str3, str4, str5, str6);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
