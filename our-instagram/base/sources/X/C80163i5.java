...
public final class C80163i5 implements C2YT {
    public static final C80163i5 A00 = new Object();
    ...
    public final C2YU Cgz(C2YR c2yr, long j) {
        if (C78613fT.A06(j) && C78613fT.A05(j)) {
            return new C2YU(AbstractC78673fZ.A00(C78613fT.A01(j), C78613fT.A00(j)), null);
        }
        throw new IllegalArgumentException(AbstractC111324zv.A00(1700));
    }
}
