...
public final class C45821KQa extends OptimisticNetworkOperation {
    public C6C9 A00;
    ...
    public C45821KQa(NotesApi notesApi, NotesRepository notesRepository, String str, List list, List list2, int i, long j) {
        super(notesApi);
