...
public abstract class RNL extends AbstractC64895TYv implements List, RandomAccess {
    public static final RND A00 = new RNC(RNK.A02, 0);
    ...
    public final RNL subList(int i, int i2) {
        if (this instanceof RNI) {
            RNI rni = (RNI) this;
            AbstractC63068Sbp.A02(i, i2, rni.A01);
            RNL rnl = rni.A02;
            int i3 = rni.A00;
            return rnl.subList(i + i3, i2 + i3);
        }
        AbstractC63068Sbp.A02(i, i2, size());
        int i4 = i2 - i;
        if (i4 == size()) {
            return this;
        }
        ...
        return new RNI(this, i, i4);
    }

    @Override // java.util.List
    /* renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final RND listIterator(int i) {
        int size = size();
        if (i >= 0 && i <= size) {
            if (isEmpty()) {
                return A00;
            }
            return new RNC(this, i);
        }
