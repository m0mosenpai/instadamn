...
public abstract class AbstractC40247HtD {
    public static H5D parseFromJson(C16L c16l) {
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                } else if ("asset_infos".equals(A0s)) {
            ...
            return new H5D(num, str, str2, str3, str4, arrayList);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
