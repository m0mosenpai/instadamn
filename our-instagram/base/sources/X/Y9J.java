...
public final class Y9J implements InterfaceC40591uS {
    ...
    public final InterfaceC37781pG A09;
    public final C38951rU A0A;

    private HandlerC72129XPb A00() {
        HandlerC72129XPb handlerC72129XPb = this.A02;
        if (handlerC72129XPb == null) {
            HandlerC72129XPb handlerC72129XPb2 = new HandlerC72129XPb(this.A09.ALb("Analytics-NormalPri-InMemory-Scheduler", 10).getLooper(), this);
            this.A02 = handlerC72129XPb2;
            return handlerC72129XPb2;
        }
        return handlerC72129XPb;
    }

    @Override // X.InterfaceC40591uS
    public final void Ct2() {
        if (this.A00 != null) {
            HandlerC72129XPb A00 = A00();
    ...
    public Y9J(Context context, C39911tF c39911tF, C04060Jx c04060Jx, C38951rU c38951rU) {
        this.A08 = context;
        this.A04 = c39911tF;
        this.A0A = c38951rU;
        try {
            ...
            this.A09 = C39251s2.A00(context).A04(c39911tF.A03.getName());
