...
public final class RunnableC64590TLb implements Runnable {
    public final /* synthetic */ List A00;

    public RunnableC64590TLb(List list) {
        this.A00 = list;
    }
    ...
    public final void run() {
        ...
        C218914p.A00().markerAnnotate(694564060, andIncrement, "operation", "onAppForegrounded_timeSensitive");
        C218914p.A00().markerAnnotate(694564060, andIncrement, "asl_session_id", C0L6.A01());
        if (AbstractC58321PtD.A1Y("onAppForegrounded_timeSensitive", andIncrement, size)) {
            if (AbstractC166987dD.A1a(AbstractC15930qn.A02.A05.invoke())) {
                try {
                    for (InterfaceC12870lZ interfaceC12870lZ : A1E) {
                        ...
                        AbstractC58321PtD.A0a("onAppForegrounded_timeSensitive", andIncrement2).markerAnnotate(694559790, andIncrement2, "listener", AnonymousClass001.A0g("<cls>", A0h, "</cls>"));
                        if (AbstractC58321PtD.A1X("onAppForegrounded_timeSensitive", andIncrement2)) {
                            try {
                ...
                for (InterfaceC12870lZ interfaceC12870lZ2 : A1E) {
                    try {
                        ...
                        AbstractC58321PtD.A0a("onAppForegrounded_timeSensitive", andIncrement3).markerAnnotate(694559790, andIncrement3, "listener", AnonymousClass001.A0g("<cls>", A0h2, "</cls>"));
                        if (AbstractC58321PtD.A1X("onAppForegrounded_timeSensitive", andIncrement3)) {
                            try {
            ...
            for (InterfaceC12870lZ interfaceC12870lZ3 : A1E) {
                ...
                AbstractC58321PtD.A0a("onAppForegrounded_timeSensitive", andIncrement4).markerAnnotate(694559790, andIncrement4, "listener", AnonymousClass001.A0g("<cls>", A0h3, "</cls>"));
                if (AbstractC58321PtD.A1X("onAppForegrounded_timeSensitive", andIncrement4)) {
                    try {
