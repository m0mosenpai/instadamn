...
public final class EfL extends C33H {
    public final /* synthetic */ C54212eX A00;

    public EfL(C54212eX c54212eX) {
        this.A00 = c54212eX;
    }
    ...
    public final void Dtq(C5SW c5sw) {
        ...
        AbstractC167017dG.A1L(A0q.ARD(), A0q, "preference_double_tap_profile_tab_tooltip_impressions", 0);
        C19740y2 A00 = AbstractC19730y1.A00(c18720vz);
        long currentTimeMillis = System.currentTimeMillis();
        InterfaceC19610xo A0P = AbstractC31171DnF.A0P(A00);
        A0P.E7G("preference_double_tap_profile_tab_tooltip_last_impression_time", currentTimeMillis);
        A0P.apply();
        C54212eX c54212eX = this.A00;
        Map map = C54212eX.A0V;
        UserSession userSession = c54212eX.A0J;
        if (userSession != null) {
            C31514Dsy.A07(userSession, "double_tap");
        }
    }
}
