...
public final class C36381mw implements C0KV {
    public static final C36381mw A00 = new C36381mw();

    @Override // X.C0KV
    public final /* bridge */ /* synthetic */ Object AXR(UserSession userSession) {
        int A03 = C0f9.A03(-1418273774);
        int A032 = C0f9.A03(1446826899);
        C14360o3.A0B(userSession, 0);
        final C2DS A002 = AbstractC28761aE.A00(userSession);
        C4L3 c4l3 = new C4L3(A002) { // from class: X.4LS
            ...
            public final AbstractC1333760g E6D(C5lP c5lP, C125205lR c125205lR, List list, Map map, InterfaceC16620sF interfaceC16620sF, InterfaceC16620sF interfaceC16620sF2, boolean z) {
                ...
                if (obj != null && C14360o3.A0K(c125205lR.A00, "replace")) {
                    ...
                    if (number == null) {
                        ...
                        return new C1334160k(new Exception("timestamp is missing for policy violation reported"), "PolicyViolation_IrisSyncMessageProcessor", "timestamp is missing for policy violation reported");
                    }
                    C2DS c2ds = this.A00;
                        ...
                        synchronized (A0P) {
                            ...
                            if (((Boolean) c81663kb.A05.getValue()).booleanValue()) {
                                ...
                                try {
                                    ...
                                    if (c125805mV3 == null) {
                                        c125805mV2 = new C125805mV(longValue, 0L, "UNKNOWN");
                                    } else {
                                        c125805mV2 = new C125805mV(longValue, c125805mV3.A01, c125805mV3.A00());
                                    }
                                ...
                                synchronized (c80693iy2) {
                                    try {
                                        ...
                                        if (c125805mV4 == null) {
                                            ...
                                            c125805mV = new C125805mV(longValue, c125805mV4.A01, c125805mV4.A00());
                                        }
        ...
        C0f9.A0A(593463457, A032);
        C0f9.A0A(-1017370130, A03);
        return c4l3;
    }
}
