...
public abstract class AbstractC63065Sbm {
    ...
    public static void A01(int i, int i2) {
        ...
        throw AbstractC58318PtA.A0a(S2W.A00(str, A1Z));
    }
    ...
    public static void A02(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 >= 0 && i2 <= i3) {
                    A00 = S2W.A00("end index (%s) must not be less than start index (%s)", AbstractC25228BEl.A1Z(Integer.valueOf(i2), i));
                } else {
