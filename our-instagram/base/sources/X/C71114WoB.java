...
public final class C71114WoB implements InterfaceC37231Gag {
    public final C33300Env A00;

    public C71114WoB(C33300Env c33300Env) {
        C14360o3.A0B(c33300Env, 1);
        this.A00 = c33300Env;
    }
    ...
    public final InterfaceC37287Gbo B8k() {
        C2JS A02 = this.A00.A01.A02(C67490Umq.class, "friend_requests", 1931829463);
        if (A02 != null) {
