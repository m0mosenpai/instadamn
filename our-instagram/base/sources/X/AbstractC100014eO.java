...
public abstract class AbstractC100014eO {
    public static C106804rh parseFromJson(C16L c16l) {
        C14360o3.A0B(c16l, 0);
        try {
            ...
            return new C106804rh(user, str, str2, str3, str4, str5, str6);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
