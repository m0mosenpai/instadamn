...
public abstract class AbstractC33751Evd {
    public static E6U parseFromJson(C16L c16l) {
        C14360o3.A0B(c16l, 0);
        try {
            ...
            while (c16l.A1J() != C16R.A09) {
                ...
                if ("channel_list".equals(A0s)) {
                    if (c16l.A11() == C16R.A0C) {
                        ...
                        while (c16l.A1J() != C16R.A08) {
                            E8D parseFromJson = AbstractC33752Eve.parseFromJson(c16l);
                ...
                } else if ("ranking_request_id".equals(A0s)) {
                    if (c16l.A11() == C16R.A0G) {
                        str2 = null;
                    } else {
                        str2 = c16l.A1P();
            ...
            return new E6U(num, num2, str, str2, str3, str4, str5, arrayList);
        } catch (IOException e) {
            throw e;
        } catch (Exception e2) {
