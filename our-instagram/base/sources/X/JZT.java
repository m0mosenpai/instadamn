...
public final class JZT implements C11R {
    ...
    public final void run() {
        ...
        if (num != null && (intValue = num.intValue()) < (threadPriority = Process.getThreadPriority(Process.myTid()))) {
            if (Systrace.A0E(1L)) {
                C0fO.A01(AbstractC167017dG.A0n(num, "ScopedBoost priority=", AbstractC166987dD.A1C()), 1060830120);
            }
    ...
    public JZT(C11R c11r, Integer num) {
        this.A00 = c11r;
        this.A01 = num;
    }
}
