...
public final class C152906uK {
    public final /* synthetic */ ProfileMediaTabFragment A00;

    public C152906uK(ProfileMediaTabFragment profileMediaTabFragment) {
    ...
    public final void A00() {
        ...
        if (recyclerView != null && recyclerView.A1D()) {
            recyclerView.post(new Runnable() { // from class: X.J3K
                @Override // java.lang.Runnable
                public final void run() {
                    HY3 hy32;
                    ProfileMediaTabFragment profileMediaTabFragment2 = C152906uK.this.A00;
