...
public final class C56230Oxd implements InterfaceC58189Pqv {
    public int A00;
    public int A01;
    public C8MA A02;
    ...
    public static void A00(C56230Oxd c56230Oxd, int i) {
        c56230Oxd.A03.getClass();
        FilterModel A0C = MSX.A0C(((FilterGroupModelImpl) c56230Oxd.A03).A02, 9);
        A0C.getClass();
        ((ColorFilter) A0C).A00 = i / 100.0f;
        c56230Oxd.A03.EUV(9, AbstractC167007dF.A1O(i));
    }
    ...
    public final View Aa0(Context context) {
        ...
        A08.setCurrentValue(i);
        C56782PHz.A01(A08, this, 6);
        this.A06 = A08;
        ...
        linearLayout.setContentDescription(AbstractC166997dE.A0r(linearLayout.getResources(), "Lux", 2131974211));
        return linearLayout;
    }
    ...
    public final boolean DkF(View view, ViewGroup viewGroup, C8MA c8ma, FilterGroupModel filterGroupModel) {
        ...
        this.A02 = c8ma;
        FilterModel A0C = MSX.A0C(((FilterGroupModelImpl) filterGroupModel).A02, 9);
        A0C.getClass();
    ...
    public C56230Oxd(UserSession userSession) {
