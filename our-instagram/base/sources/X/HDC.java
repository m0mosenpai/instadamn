...
public final class HDC extends C38K implements InterfaceC71989XEc, AbsListView.OnScrollListener, GZU, InterfaceC60122ou, InterfaceC37188GZz {
    public static final String __redex_internal_original_name = "ReelFundraiserDonorsListFragment";
    public UserSession A00;
    public Reel A01;
    public OJL A02;
    public FR7 A03;
    public C31543DtT A04;
    public HEC A05;
    public C41181vS A07;
    public C38E A08;
    public String A09;
    ...
    public final void D4K(Reel reel, GradientSpinnerAvatarView gradientSpinnerAvatarView) {
        ...
        if (c38e == null) {
            ...
            if (str2 == null) {
                ...
                c38e.A0C = str2;
                C42790IwS.A00(getActivity(), gradientSpinnerAvatarView.getAvatarBounds(), c38e, this, 5);
    ...
    public final void DXH(C38266GsB c38266GsB) {
        ...
        if (user != null) {
            Reel reel = this.A01;
            if (reel != null) {
                ojl.A00(reel, new C42802Iwe(0, c38266GsB, this), user, "reel_fundraiser_donors_list");
                return;
            }
    ...
    public final void DtX(User user) {
        ...
        Reel reel = this.A01;
        if (reel != null) {
            fr7.A01(this, user, "fundraiser_donors_list", false, reel.A0d());
            return;
        }
    ...
    public final void E17(C38266GsB c38266GsB) {
        ...
        if (userSession != null) {
            if (user != null) {
                C31368DqX A01 = AbstractC31402Dr6.A01(userSession, user.getId(), "reel_fundraiser_donors_list", "reel_fundraiser_donors_list");
        ...
        if (c41181vS != null) {
            ...
            if (c31543DtT != null) {
                ...
                if (c38321qM != null) {
                    ...
                    C84823qW A00 = AbstractC120715dH.A00(EnumC75383a5.A0b, c41181vS.A0c());
                    if (A00 != null) {
                        C189138Ze c189138Ze = A00.A0z;
                        if (c189138Ze != null) {
                            int[] iArr = AlB.A02;
                            String str = c189138Ze.A08;
                            C31543DtT c31543DtT2 = this.A04;
                            if (c31543DtT2 != null) {
                                String str2 = c31543DtT2.A00;
                                C25621Ms A0M = AbstractC31177DnL.A0M(userSession);
                                A0M.A0B("media/story_fundraiser_donations/");
                                A0M.A9s("fundraiser_id", str);
                                A0M.A9s("media_id", A38);
                                A0M.A0R(H9O.class, IP7.class);
                                if (str2 != null) {
                                    A0M.A9s("max_id", str2);
                                }
                                C1ON A0N = A0M.A0N();
                                C37484Gf2.A00(A0N, c41181vS, this, 33);
                                schedule(A0N);
                                return;
                            }
                        } else {
    ...
    public static final void A02(HDC hdc) {
        String str;
        ...
        if (c31543DtT == null) {
            ...
            c31543DtT.A02 = true;
            AbstractC31177DnL.A18(hdc, C56352iT.A0t, true);
            HEC hec = hdc.A05;
            if (hec == null) {
                str = "adapter";
            } else {
    ...
    */
    public static final void A03(X.HDC r2) {
        /*
            X.DtT r1 = r2.A04
        ...
        L1c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.HDC.A03(X.HDC):void");
    }
    ...
    public final void configureActionBar(InterfaceC56362iU interfaceC56362iU) {
        AbstractC31175DnJ.A1I(interfaceC56362iU, AbstractC31176DnK.A05(this, interfaceC56362iU).getString(2131971713));
    }

    @Override // androidx.fragment.app.Fragment
    public final void onCreate(Bundle bundle) {
        int A02 = C0f9.A02(-704167449);
        ...
        if (userSession != null) {
            ...
            UserSession userSession3 = this.A00;
            if (userSession3 != null) {
                this.A04 = new C31543DtT(this, userSession3, this);
                ...
                if (userSession4 != null) {
                    ...
                    if (c31543DtT == null) {
                        ...
                        this.A05 = new HEC(requireContext, this, userSession4, this, c31543DtT);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        int A02 = C0f9.A02(988718052);
        C14360o3.A0B(layoutInflater, 0);
        View inflate = layoutInflater.inflate(R.layout.layout_listview_with_progress, viewGroup, false);
        C0f9.A09(-1993785802, A02);
        return inflate;
    }

    @Override // X.C38K, androidx.fragment.app.Fragment
    public final void onResume() {
        int A02 = C0f9.A02(327793682);
        super.onResume();
        if (!C06P.A00(AbstractC31174DnI.A0I(this)) && this.A07 == null) {
            AbstractC25226BEj.A1Q(this);
        }
        AbstractC37305Gc6.A03(requireActivity(), this);
        C0f9.A09(-1906332217, A02);
    }

    @Override // android.widget.AbsListView.OnScrollListener
    public final void onScroll(AbsListView absListView, int i, int i2, int i3) {
        int A0N = AbstractC167017dG.A0N(absListView, -530117418);
        this.A0A.onScroll(absListView, i, i2, i3);
        C0f9.A0A(-1420325876, A0N);
    }

    @Override // android.widget.AbsListView.OnScrollListener
    public final void onScrollStateChanged(AbsListView absListView, int i) {
        int A0N = AbstractC167017dG.A0N(absListView, 1034891390);
        this.A0A.onScrollStateChanged(absListView, i);
        C0f9.A0A(125084602, A0N);
    }

    @Override // androidx.fragment.app.Fragment
    public final void onStart() {
        int A02 = C0f9.A02(1384065433);
        super.onStart();
        A03(this);
        C0f9.A09(-808472742, A02);
    }
}
