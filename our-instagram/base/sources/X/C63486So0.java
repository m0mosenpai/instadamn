...
public final class C63486So0 implements KeyListener {
    ...
    */
    public final boolean onKeyDown(android.view.View r4, android.text.Editable r5, int r6, android.view.KeyEvent r7) {
        /*
            ...
            if (r6 != r0) goto L15
            boolean r0 = X.C55092g9.A01(r5, r7, r1)
        Le:
            if (r0 == 0) goto L15
        ...
        L15:
            ...
            goto L13
        L1f:
            boolean r0 = X.C55092g9.A01(r5, r7, r0)
            goto Le
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C63486So0.onKeyDown(android.view.View, android.text.Editable, int, android.view.KeyEvent):boolean");
    }
    ...
    public C63486So0(KeyListener keyListener) {
