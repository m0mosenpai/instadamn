...
public final class RYz<E> extends TZA<E> implements RandomAccess {
    public static final RYz A02;
    public Object[] A01 = new Object[10];
    public int A00 = 0;

    /* JADX WARN: Type inference failed for: r0v0, types: [X.RYz, X.TZA] */
    static {
        ?? tza = new TZA();
        tza.A01 = new Object[0];
        tza.A00 = 0;
        A02 = tza;
        tza.A00 = false;
    }
    ...
    /* JADX WARN: Type inference failed for: r0v3, types: [X.RYz, X.TZA, X.TsE] */
