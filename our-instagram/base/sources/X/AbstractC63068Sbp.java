...
public abstract class AbstractC63068Sbp {
    public static String A00(String str, int i, int i2) {
        ...
        return AbstractC62210S2f.A00(str2, A1a);
    }
    ...
    public static void A01(int i, int i2) {
        ...
        throw AbstractC58318PtA.A0a(AbstractC62210S2f.A00(str, A1Z));
    }
    ...
    public static void A02(int i, int i2, int i3) {
        ...
        if (i >= 0) {
            ...
            if (i <= i3) {
                if (i2 >= 0 && i2 <= i3) {
                    A00 = AbstractC62210S2f.A00("end index (%s) must not be less than start index (%s)", AbstractC25228BEl.A1Z(Integer.valueOf(i2), i));
                } else {
