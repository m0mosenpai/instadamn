...
public final class C5PG implements C5PH {
    public final Random A00;
    public final int[] A01;
    public final int[] A02;

    @Override // X.C5PH
    public final C5PG AI9(int i, int i2) {
        int[] iArr = new int[i2];
        ...
        return new C5PG(new Random(this.A00.nextLong()), iArr4);
    }

    public C5PG(Random random, int[] iArr) {
        this.A02 = iArr;
        this.A00 = random;
