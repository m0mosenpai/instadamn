...
public final class C23857Ah9 implements InterfaceC25185BCi {
    ...
    public C23857Ah9(Context context, UserSession userSession, C1GL c1gl, AbstractC24481Hr abstractC24481Hr, C22925A8v c22925A8v, FilterGroupModel filterGroupModel, C47Z c47z, C183978Ee c183978Ee, Runnable runnable, boolean z, boolean z2) {
    ...
    public final void DXM(String str) {
        ...
        if (C18U.A06(c06090Tz, userSession, 36327615073630946L) && (decodeFile = BitmapFactory.decodeFile(str, new BitmapFactory.Options())) != null) {
            ...
            A03.A0I = AbstractC166987dD.A0B(i / max, 100.0f);
        }
        A03.A33 = str;
        C47Z c47z = this.A06;
        c47z.A0V(A03);
