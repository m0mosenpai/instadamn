...
public final class C29689D7f extends C0YY implements InterfaceC16820sZ {
    public final /* synthetic */ Fragment A00;
    public final /* synthetic */ String A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C29689D7f(Fragment fragment, String str) {
        super(0);
        this.A00 = fragment;
        this.A01 = str;
    }
    ...
    public final Object invoke() {
        Object A0m;
        if (Serializable.class.isAssignableFrom(ContentNotesImmersiveCreationUiState.class)) {
        ...
        } else if (AbstractC25226BEj.A1a(ContentNotesImmersiveCreationUiState.class)) {
            A0m = AbstractC25231BEo.A0m(this.A00, this.A01);
        } else {
            throw AbstractC25231BEo.A0i(this.A01);
        }
        if (!(A0m instanceof ContentNotesImmersiveCreationUiState)) {
            return null;
        }
        return A0m;
    }
